...
RST_08:			RST.LIS		08h		; MOS API call
			RET
			DS 		5
			
RST_10:			RST.LIS 	10h		; Display character
			RET
			DS		5
			
RST_18:			RST.LIS 	18h		; Display string
			RET
			DS		5
RST_20:			DS		8
RST_28:			DS		8
...
_exec_name:		DB	"ANSIPLAY.BIN", 0		; The executable name, only used in argv
...
; - BCU
;
_set_ahl24:	PUSH.LIL	HL			; Preserve HL
;			PUSH.LIL	BC			; Stick BC onto SPL
			LD.LIL		HL, 2			; HL: SP+2
			ADD.LIL		HL, SP
			LD.LIL		(HL), A			; Store A in it
