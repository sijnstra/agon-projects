...
#
# ZDS II Make File - memsave project, Release configuration
#
...
# project directory
PRJDIR = D:\agon\agon-projects-main\ASM\memsave
PRJDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\memsave

# intermediate files directory
WORKDIR = D:\agon\agon-projects-main\ASM\memsave\Release
WORKDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\memsave\Release

# output files directory
OUTDIR = D:\agon\agon-projects-main\ASM\memsave\Release\
OUTDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\memsave\Release\
...
LDFLAGS = @.\memsave_Release.linkcmd
build: memsave relist

buildall: clean memsave relist

relink: deltarget memsave

deltarget: 
	@if exist "$(WORKDIR)\memsave.lod"  \
            $(RM) "$(WORKDIR)\memsave.lod"
	@if exist "$(WORKDIR)\memsave.hex"  \
            $(RM) "$(WORKDIR)\memsave.hex"
	@if exist "$(WORKDIR)\memsave.map"  \
            $(RM) "$(WORKDIR)\memsave.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\memsave\Release\memsave.map" \
            D:\agon\agon-projects-main\ASM\memsave\init.asm
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\memsave\Release\memsave.map" \
            D:\agon\agon-projects-main\ASM\memsave\main.asm
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\memsave\Release\memsave.map" \
            D:\agon\agon-projects-main\ASM\memsave\output.asm
