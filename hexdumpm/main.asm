...
;	db	'	optional paramter c uses hexdump in continuous mode.',CR,LF
	db 	'Store hexdumpm.bin in /mos directory. Minimum MOS version 1.03.',CR,LF,CR,LF,0
	ret
...
main_loop:
	...
	rst		10h
	call	inline_print
	db		17,10,'hexdump memory utility - interactive mode',17,15,CR,LF
;	db		'Filename:',0
;	LD.LIL		HL,(IX+3)
;	call	print_HL
;	call	inline_print
