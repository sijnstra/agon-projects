...
#
# ZDS II Make File - hexdumpm project, Release configuration
#
...
# project directory
PRJDIR = D:\agon\agon-projects-main\ASM\hexdumpm
PRJDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\hexdumpm

# intermediate files directory
WORKDIR = D:\agon\agon-projects-main\ASM\hexdumpm\Release
WORKDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\hexdumpm\Release

# output files directory
OUTDIR = D:\agon\agon-projects-main\ASM\hexdumpm\Release\
OUTDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\hexdumpm\Release\
...
LDFLAGS = @.\hexdumpm_Release.linkcmd
build: hexdumpm relist

buildall: clean hexdumpm relist

relink: deltarget hexdumpm

deltarget: 
	@if exist "$(WORKDIR)\hexdumpm.lod"  \
            $(RM) "$(WORKDIR)\hexdumpm.lod"
	@if exist "$(WORKDIR)\hexdumpm.hex"  \
            $(RM) "$(WORKDIR)\hexdumpm.hex"
	@if exist "$(WORKDIR)\hexdumpm.map"  \
            $(RM) "$(WORKDIR)\hexdumpm.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\hexdumpm\Release\hexdumpm.map" \
            D:\agon\agon-projects-main\ASM\hexdumpm\init.asm
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\hexdumpm\Release\hexdumpm.map" \
            D:\agon\agon-projects-main\ASM\hexdumpm\main.asm
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\hexdumpm\Release\hexdumpm.map" \
            D:\agon\agon-projects-main\ASM\hexdumpm\output.asm
