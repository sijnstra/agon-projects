...
; Parameters:
; - HL: 16-bit value
; -  A: Value to stick in U of HL
; Returns:
; - HLU
;
_set_ahl24:
			PUSH.LIL	HL			; Stick HL onto SPL
			LD.LIL		HL, 2			; HL: SP+2
			ADD.LIL		HL, SP
			LD.LIL		(HL), A			; Store A in it
			POP.LIL		HL			; Fetch ammended HL
			RET

; Get the MSB of HL (U) to A
; Parameters:
; - HLU: 24-bit value
; Returns:
; - A: Value of U
