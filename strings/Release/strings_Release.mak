...
#
# ZDS II Make File - strings project, Release configuration
#
...
# project directory
PRJDIR = D:\agon\agon-projects-main\ASM\strings
PRJDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\strings

# intermediate files directory
WORKDIR = D:\agon\agon-projects-main\ASM\strings\Release
WORKDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\strings\Release

# output files directory
OUTDIR = D:\agon\agon-projects-main\ASM\strings\Release\
OUTDIR_ESCSPACE = D:\agon\agon-projects-main\ASM\strings\Release\
...
LDFLAGS = @.\strings_Release.linkcmd
build: strings relist

buildall: clean strings relist

relink: deltarget strings

deltarget: 
	@if exist "$(WORKDIR)\strings.lod"  \
            $(RM) "$(WORKDIR)\strings.lod"
	@if exist "$(WORKDIR)\strings.hex"  \
            $(RM) "$(WORKDIR)\strings.hex"
	@if exist "$(WORKDIR)\strings.map"  \
            $(RM) "$(WORKDIR)\strings.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\strings\Release\strings.map" \
            D:\agon\agon-projects-main\ASM\strings\init.asm
	$(AS) $(ASFLAGS) -relist:"D:\agon\agon-projects-main\ASM\strings\Release\strings.map" \
            D:\agon\agon-projects-main\ASM\strings\main.asm
